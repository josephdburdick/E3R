...
<br><br>&nbsp;
     ...
     <font class="TallRed">NEW E3R FEATURE!<a name="108676748109020012">&nbsp;</a></font>
		<div class="blackjustified" style="background-color:#eeeeee;padding:5px 5px 5px 5px;border-top:3px solid #cccccc;border-bottom:1px solid #333333;border-left:1px solid #cccccc;border-right:1px solid #cccccc;">
          The post below this one is an example of the new posting feature for E3R. Thanks to the universal system Blogger/Google is using, every member of E3R can post by phone. Honestly, this will be really helpful when I'm riding the metro in the mornings and have nothing better to do. It's completely free and there's no waiting involved! All you do is (first setup an account @ <a href="http://www.audioblogger.com">audioblogger</a> by using the same Username and Password you use to sign into E3R's Blogger system) then all you do is call a certain number, put in your pin, and speak! when you're done sayin whatever you need to say, press the pound key and you're done. Wow, this is going to be very addicting.<br />
          <div class="byline">
<b>jd.b!</b>&nbsp;@ 3:45 AM [<a href="http://www.devlogik.com/www/E3R_2/blog/2004/06/new-e3r-feature.php" title="permanent link">#</a>|<a href="mailto:devlogik@gmail.com?subject=RE: E3R POST #108676748109020012&body=Hey jd.b!!">e</a>]</div>
		</div><br>
		...
		<div class="blogComments"><br />
			...
			<a href="http://www.blogger.com/comment.g?blogID=6900590&postID=108676748109020012">Post a Comment</a>
		</div>
