...
<br><br>&nbsp;
          ...
          <div class="date" style="text-align:right;float:right;">8.15.2004</div><br /><br />
     
     
     <font class="TallRed">WinXP SP2 Glitch?<a name="109261311790127897">&nbsp;</a></font>
		<div class="blackjustified" style="background-color:#eeeeee;padding:5px 5px 5px 5px;border-top:3px solid #cccccc;border-bottom:1px solid #333333;border-left:1px solid #cccccc;border-right:1px solid #cccccc;">
          Looks like their is a bug... Shocker... When I click on a link to a file sometimes, it opens the file as if it is a text or doc file. This is happening with ZIP, RAR, WMV, etc.. Anyone elses experiencing this?<br />
          <div class="byline">
<b>TuuKAholiC</b>&nbsp;@ 7:37 PM [<a href="http://www.devlogik.com/www/E3R_2/blog/2004/08/winxp-sp2-glitch.php" title="permanent link">#</a>|<a href="mailto:jfk_two@yahoo.com?subject=RE: E3R POST #109261311790127897&body=Hey TuuKAholiC!">e</a>]</div>
		</div><br>
		...
		<div class="blogComments"><br />
			...
			<div class="blogComment">
				<a name="109262531453341355"></a> 
				I assume you mean that this is happening in Internet Explorer.  I have not had this problem in the week or so I've been running SP2, but I've only run IE as part of running Windows Update.  I can't tell you where to fix the problem, but your problem has to do with IE recognizing the MIME type of the file.  Web browsers have a routine of "When all else fails, it's text."  Up until a couple of years ago most people had hell downloading ZIPs and things in Linux because most every browser didn't recognize common MIME types by default.  I can still remember the text of my first Real Player movie in Linux  8?}<br /><br />Google for IE MIME types, SP2 MIME reset, or something along those lines.  I didn't see anything related on my cursory hunt through Internet Options.  If I get some time, I'll dig up what I can and get back to you.  Oh, and even if this isn't happening in IE, the cause is still the same (MIME registry for whatever you're using).<br /><br />-Robby<br />
				<div class="byline"><a href="http://www.devlogik.com/www/E3R_2/blog/2004/08/winxp-sp2-glitch.php#109262531453341355" title="permanent link">#</a> posted by <a href="http://www.blogger.com/profile/3651112">Robstafarian</a> @ 11:01 PM</div>
				<span class="item-control admin-800438703 pid-375792846"><a style="border:none;" href="http://www.blogger.com/delete-comment.do?blogID=6900590&postID=109262531453341355" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
			<a href="http://www.blogger.com/comment.g?blogID=6900590&postID=109261311790127897">Post a Comment</a>
		</div>
