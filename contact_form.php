...
WHoa, missing something!<br></span>
      <span class="black">Unable to create account due to missing information.<br><br>
...
WHoa, missing something!<br></span>
	...
	<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
      <tr>
        <td class="black"><b>You neglected to fill in these required fields:</b><blockquote>';
...
mail("devlogik@gmail.com","# E3R APPLICATION -> $name",stripslashes($msg), $mailheaders);
include "index_top.txt";
include "index_header.txt";
echo '<span class="TallRed">
Application Sent Successfully!<br>
</span><span class="black">Congrats, you should hear from us soon.</font></td>
	  <td width="460" valign="top" style="padding:10px 10px 10px 10px;">
	<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
      <tr>
        <td class="black">
